      ...
      <div className='sidebarprofile shadow-lg'>
        ...
        <div className='profileproperties'>
          <ul>
            ...
            <li className='mt-3'>
              <Link className='listItem LatestList' to="/NewsBlog"><FcNews className='Listicon'/>Latest News</Link>
            </li>
            <li className='mt-3'>
            ...
            <li className='mt-3'>
              <Link className='listItem SettingList' to="/NotificationSetting"><LuSettings className='Listicon'/>Settings</Link>
            </li>
          </ul>
        </div>
        <hr></hr>
